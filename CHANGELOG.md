...
- **Archive confirmation flag**: Classic archive now requires `--confirm-archive` for mutating archive runs, preventing a skipped final confirmation from immediately moving a change into archive and marking it archived.
